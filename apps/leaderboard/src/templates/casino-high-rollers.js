...
body[data-template="highRollers"] .hr-tab { background: transparent; border: 1px solid var(--hr-border); color: var(--hr-muted); border-radius: 999px; padding: 0.45rem 1rem; font-size: 0.85rem; font-weight: 500; font-family: inherit; cursor: default; }
