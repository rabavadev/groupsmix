...
<h2>Payments</h2>
<p>Paid plans — Starter, Pro, Agency (30-day fixed-term access), and one-time Lifetime Pro — are paid either in cryptocurrency through our payment processor, NOWPayments (BTC, ETH, USDT and 100+ more), or via Telegram Stars through the Telegram bot. Access does not auto-renew; purchase another 30-day period before expiry to keep features. Before paying, you can start a one-time 7-day free Pro trial.</p>
<p>Crypto payments are final once confirmed and non-refundable because of blockchain irreversibility. Payments via Telegram Stars are processed directly through Telegram's payment system and are subject to Telegram's refund policy. See our <a href="/refund">refund policy</a> for full details. Your paid features last until the end of the purchased period, after which your page reverts to the Free plan (player limit and badge apply again).</p>
