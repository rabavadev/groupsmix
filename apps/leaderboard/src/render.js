...
<button class="btn btn--full btn--code" data-copy-code>Copy Code</button>
<a class="btn btn--full btn--grad" data-cta href="${esc(opts.slug ? `/go/${opts.slug}` : b.ctaUrl || "#")}" target="_blank" rel="noopener">Join us on <span data-casino>${esc(b.casino || "Stake")}</span></a></div>
