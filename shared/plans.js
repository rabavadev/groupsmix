...
// (Plain JS mirror of shared/plans.ts for Workers that don't use TS.)
// ------------------------------------------------------------------
...
/** @type {Record<string, {tier: string, label: string, maxBots: number, maxOffers: number, broadcasts: boolean, postbacks: boolean, starsPrice: number}>} */
